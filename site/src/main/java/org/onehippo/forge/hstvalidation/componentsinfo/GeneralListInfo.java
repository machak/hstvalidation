...
package org.onehippo.forge.hstvalidation.componentsinfo;
...
public interface GeneralListInfo  {
    ...
    @Parameter(name = "docType", defaultValue="hstvalidation:basedocument", displayName = "Document Type", typeHint = ComponentWrapper.ParameterType.STRING)
    String getDocType();
